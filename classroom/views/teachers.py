...
from ..forms import BaseAnswerInlineFormSet,TeacherSignUpForm,AppointmentForm,SymptomForm,DiseaseForm,FeedBackForm
from ..models import User,Appointment,Symptom,Disease,FeedBack
...
class TeacherSignUpView(CreateView):
    ...
    def form_valid(self, form):
        ...
        return redirect('teachers:appointment_list')

@method_decorator([login_required, teacher_required], name='dispatch')
class AppointmentListView(ListView):
    model=Appointment
    template_name='classroom/teachers/appointment_list.html'
...
class AppointmentCreateView(CreateView):
    ...
    template_name='classroom/teachers/appointment_form.html'
...
class AppointmentDetailView(DetailView):
    model = Appointment
    template_name='classroom/teachers/appointment_detail.html'
...
class SymptomListView(ListView):
    model = Symptom
    template_name='classroom/teachers/symptom_list.html'


class SymptomCreateView(CreateView):
    model = Symptom
    form_class = SymptomForm
    template_name='classroom/teachers/symptom_form.html'


class SymptomDetailView(DetailView):
    model = Symptom
    template_name='classroom/teachers/symptom_detail.html'
...
class DiseaseListView(ListView):
    model = Disease
    template_name='classroom/teachers/disease_list.html'


class DiseaseCreateView(CreateView):
    model = Disease
    form_class = DiseaseForm
    template_name='classroom/teachers/disease_form.html'


class DiseaseDetailView(DetailView):
    model = Disease
    template_name='classroom/teachers/disease_detail.html'
...
class FeedBackListView(ListView):
    model = FeedBack
    template_name='classroom/teachers/feedback_list.html'

class FeedBackCreateView(CreateView):
    model = FeedBack
    form_class = FeedBackForm
    template_name='classroom/teachers/feedback_form.html'

class FeedBackDetailView(DetailView):
    model = FeedBack
    template_name='classroom/teachers/feedback_detail.html'
